(function () {
  ...
  var LEGACY_CONSENT_KEY = "residencial-inglesa-analytics-consent";
  var UTM_KEY = "zn-campaign-attribution";
  var LEGACY_UTM_KEY = "residencial-inglesa-campaign-attribution";
  ...
  function showStep(step) {
    ...
    formTitle.textContent = step === 2 ? "Só mais duas informações opcionais" : "Receba unidades e condições";
    clearError();
  }
